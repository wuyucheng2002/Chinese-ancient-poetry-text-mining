...
def main():
    ...
    parser.add_argument('--length', default=64, type=int, required=False, help='生成长度')
    ...
    parser.add_argument('--model_path', default='model4/model_epoch20', type=str, required=False, help='模型路径')
    parser.add_argument('--prefix', default='[CLS]七言律诗[SEP]山川巍峨[SEP]一叶知秋[SEP]', type=str, required=False, help='生成文章的开头')
    parser.add_argument('--no_wordpiece', action='store_true', help='不做word piece切词')
    parser.add_argument('--segment', action='store_true', help='中文以词为单位')
    parser.add_argument('--fast_pattern', action='store_false', help='采用更加快的方式生成文本')
